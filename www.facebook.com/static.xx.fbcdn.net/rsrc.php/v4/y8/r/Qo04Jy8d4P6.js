  ...
  function (a, b, c, d, e, f, g) {
    ...
    if (l && k !== -1) {
      ...
      if (
        ...
        var n = null;
        d = { capture: !1, passive: !0 };
        window.addEventListener(
          "blur",
          function () {
            n = { dNow: Date.now(), pNow: (h || (h = c("performance"))).now() };
          },
          d
        );
        window.addEventListener(
...
__d(
  ...
  [],
  function (a, b, c, d, e, f) {
    a = Object.freeze({ CSR: 0, HSDP: 1, HBLP: 2 });
    f["default"] = a;
  },
  66
);
__d(
  "HasteBitMap",
  ["BitMap", "BootloaderConfig", "HasteBitMapKey"],
  function (a, b, c, d, e, f, g) {
    var h = new (c("BitMap"))();
    function a(a, b) {
      !c("BootloaderConfig").phdSeparateBitmaps
        ? h.set(b)
        : h.set(b * Object.values(c("HasteBitMapKey")).length + Number(a));
    }
    function b() {
    ...
    function b() {
      return (
        ...
        !(
          ...
          h(XMLHttpRequest.toString()) ===
            "function XMLHttpRequest() { [native code] }" &&
          h(XMLHttpRequest.toString.toString()) ===
            "function toString() { [native code] }"
        )
      );
    }
    function d(a) {
      return (
        ...
        !(
          ...
          h(a.toString()) === "function XMLHttpRequest() { [native code] }" &&
          h(a.toString.toString()) === "function toString() { [native code] }"
        )
      );
    }
    g.isJSONParseShimmed = a;
    g.isXHRModified = b;
    g.isGivenXHRModified = d;
  },
  98
);
__d(
...
__d(
  ...
  function (a, b, c, d, e, f, g, h) {
    ...
    function T(a, b, e) {
      ...
      if (f)
        for (
          var f = d("HasteResourceIndexUtil").parseResourceIndexes(f),
            g = Array.isArray(f),
            h = 0,
            f = g
              ? f
          ...
          if (i === d("HasteResourceIndexUtil").UNKNOWN_RESOURCE_INDEX)
            continue;
          (!w.has(i) || e) && w.set(i, a);
          (c("BootloaderConfig").phdOn &&
          !c("BootloaderConfig").phdSeparateBitmaps
            ? b.c == 2
            : b.c) && d("HasteBitMap").add(0, i);
        }
    }
    function U(a, b) {
      var e = D.bootload(b);
      ...
      for (var e = 0; e < a.length; e++) {
        ...
        if (g.type === "csr")
          ...
          (i = d("HasteResourceIndexUtil").parseResourceIndexes(g.p)),
            i.includes(d("HasteResourceIndexUtil").UNKNOWN_RESOURCE_INDEX) &&
              b.set(f, g),
    ...
    var $ = {
      ...
      handlePayload: function (a, b) {
        ...
        if (c("objectKeys")(i).length) {
          g = ((h = i[0]) != null ? h : []).find(function (a) {
            return !w.has(a);
          });
          f !== null && f !== c("SiteData").client_revision
            ...
            : !c("BootloaderConfig").phdSeparateBitmaps && g != null && A
            ...
            : c("objectKeys")(i).forEach(function (a) {
                return i[a].forEach(function (b) {
                  return d("HasteBitMap").add(a, b);
                });
              });
        }
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a, e) {
      ...
      e ||
        ...
        (g[c("StaticSiteData").csr_key] =
          d("HasteBitMap").toCompressedString()));
      if (
    ...
    e = (function () {
        ...
        if (this.config.extra_dom_content_event != null) {
          ...
          if (c("BigPipeExperiments").am_page_load_promise_timeout) {
            var g = c("setTimeoutAcrossTransitions")(function () {
              c("Arbiter").inform(
                f.config.extra_dom_content_event,
                {
                  pageType: "normal",
                  start: 0,
                  tti: 0,
      ...
      e._nextPhase = function () {
        this.config.flush_pagelets_asap
          ...
          : (this._currentPhase++, this._beginPhase(this._currentPhase));
      };
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    var q = new c(CSSStyleDeclaration, null, { sampleObject: k.style });
    ...
    function G() {
      ...
      D.setCustom(function (b, c, a) {
        ...
        else return D.getOriginal().apply(this, arguments);
      });
      function a(a) {
        return function (b) {
          var c,
    ...
    var aa = (function () {
      ...
      ba = (function (b) {
        ...
        function a(a, c, e) {
          ...
          z.setVirtualProperty(
            a,
            new aa(c.raw, babelHelpers.assertThisInitialized(c))
          );
          H();
          return c;
        }
    ...
    O = new c(Window, m, { targetPrototype: window, registerOnPrototype: !0 });
    ...
    function s(a) {
      l === "" &&
        c("ifRequired")("URI", function (b) {
          ...
          d && !t({ hasSmallImage: !!d, dimensions: { x: b[0], y: b[1] } })
            ? (l = d)
            : c
            ? (l = c)
            : (l = "");
...
__d(
  "VisibilityListener",
  ["Visibility", "performanceNowSinceAppStart"],
  function (a, b, c, d, e, f, g) {
    "use strict";
    var h = Date.now() - c("performanceNowSinceAppStart")(),
      i = [],
      j = !1,
      k = 1e4;
    i.push({ key: h, value: (d = c("Visibility")).isHidden() });
    function l(a, b) {
      if (j || i.length > k) {
        j = !0;
        return;
    ...
    d.addListener(d.VISIBLE, function (a) {
      l(a.changeTime, !1);
    });
    d.addListener(d.HIDDEN, function (a) {
      l(a.changeTime, !0);
    });
    function m(a, b) {
      if (j) return null;
...
__d(
  ...
  ["CSS"],
  function (a, b, c, d, e, f) {
    (a.__fbNativeCSS = a.CSS), (a.CSS = b("CSS"));
  },
  3
);
__d(
