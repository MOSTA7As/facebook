...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    var h,
      i,
      j = "BDClientSignalCollectionTrigger",
      ...
      y = Object.freeze({ NONE: 0, VITAL: 1, CRITICAL: 2 }),
      z = {
            ...
            function (c) {
              while (1)
                switch ((c.prev = c.next)) {
                  ...
                  case 8:
                    a != null &&
                      ((q = a.hbcbc && a.hbcbc > 0 ? a.hbcbc : q),
                      (r = a.hbvbc && a.hbvbc > 0 ? a.hbvbc : r),
                      (s = a.hbbi && a.hbbi > 0 ? a.hbbi : s));
                    z.startHeartbeatDelayed();
                    v = new (i || (i = b("Promise")))(function (a, b) {
                      try {
                        x.getDynamicSignals().length > 0 &&
                          (z.collectDynamicSignals(),
                          d("BDOperationLogHelper").logInfo(
                            j,
                          ...
                          x.getBiometricSignals().length > 0 &&
                            (z.collectBiometricSignals(),
                            d("BDOperationLogHelper").logInfo(
                              j,
                              d("BDLoggingConstants").OPERATIONS
                                .BIOMETRIC_SIGNAL_COLLECTION_STARTED,
              ...
              while (1)
                switch ((c.prev = c.next)) {
                  case 0:
                    c.next = 2;
                    return b("regeneratorRuntime").awrap(
                      z.collectStaticSignals()
                    );
                  case 2:
                    z._postSignalsHelper(
                      d("BDSignalBuffer").getSignalsAsJSONString(a),
                      y.NONE
                    ) && z.setTimestampInStorage(Date.now(), k);
                  case 3:
                  case "end":
                    return c.stop();
                }
        ...
        _postSignalsHelper: function (a, b) {
          ...
          a = function () {
            return { asid: w, ct: e, sjd: f, sid: x.sid };
          };
          var g = !1;
          try {
            b === y.CRITICAL
        ...
        postSignalsIntermittently: function () {
          z.postSignals([c("BDCollectionTypeEnum").STATIC]),
        ...
        startHeartbeatDelayed: function () {
          ...
          a = Date.now() - a;
          try {
            a >= x.getHeartbeatIntervalMs()
              ? z.startHeartbeat()
              : (window.setTimeout(function () {
                  return z.startHeartbeat();
                }, x.getHeartbeatIntervalMs() - a),
                (o = !0));
          } catch (b) {
            d("BDOperationLogHelper").logError(
              j,
        ...
        startHeartbeat: function () {
          !n &&
            x.getHeartbeatIntervalMs() > 0 &&
            (z.collectHeartbeatTimes(q, r),
            p !== 0 &&
        ...
        collectHeartbeat: function (a) {
          ...
          z.postHeartbeat(a, b) &&
            z.setTimestampInStorage(
              Date.now(),
              z.HEARTBEAT_TIMESTAMP_STORAGE_KEY
            );
        },
              ...
              while (1)
                switch ((a.prev = a.next)) {
                  case 0:
                    a.next = 2;
                    return b("regeneratorRuntime").awrap(
                      z.collectSignalsOneTime(x.getStaticSignals())
                    );
                  case 2:
                  case "end":
                    return a.stop();
                  ...
                  while (1)
                    switch ((a.prev = a.next)) {
                      case 0:
                        a.next = 2;
                        return b("regeneratorRuntime").awrap(
                          z.collectSignalsOneTime(x.getDynamicSignals())
                        );
                      case 2:
                      case "end":
                        return a.stop();
        ...
        getSignalsAsJSONString: function () {
          return d("BDSignalBuffer").getSignalsAsJSONString([
            c("BDCollectionTypeEnum").DYNAMIC,
            c("BDCollectionTypeEnum").STATIC,
            c("BDCollectionTypeEnum").BIOMETRIC,
          ]);
