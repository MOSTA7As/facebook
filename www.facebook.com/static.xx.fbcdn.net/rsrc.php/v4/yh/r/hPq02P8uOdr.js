    ...
    function a(a, b) {
      ...
      for (c = 1; c <= a.length; c++)
        for (d = 1; d <= b.length; d++) {
          ...
          c > 1 &&
            d > 1 &&
            a.charAt(c - 1) == b.charAt(d - 2) &&
            a.charAt(c - 2) == b.charAt(d - 1) &&
            (e[c % 3][d] = Math.min(e[c % 3][d], e[(c - 2) % 3][d - 2] + f));
        }
  ...
  function (a, b, c, d, e, f) {
    ...
    var g = {
      initContactpointFieldLogging: function (a) {
        ...
        a.addEventListener(
          "input",
          g._mayLogContactpointPrefillViaDropdown.bind(g)
        );
        window.addEventListener(
          "load",
          g._mayLogContactpointPrefillOnload.bind(g)
        );
        return;
      },
      registerCallback: function (a) {
        (g.regeisteredCallbacks = g.regeisteredCallbacks || []),
          g.regeisteredCallbacks.push(a);
      },
      _invokeCallbacks: function (a, b) {
        if (g.regeisteredCallbacks == null || g.regeisteredCallbacks.size === 0)
          return;
      ...
      initPasswordFieldLogging: function (a) {
        ...
        a.addEventListener(
          "input",
          g._mayLogPasswordPrefillViaDropdown.bind(g)
        );
      ...
      updatePrefill: function (a, c, d) {
        ...
        j != null &&
          (j.value == null || j.value === "false") &&
          d === "contact_point" &&
          (j.value = "true");
        k != null &&
          (k.value == null || k.value === "false") &&
          d === "password" &&
          (k.value = "true");
      },
      _mayLogContactpointPrefillOnload: function () {
        g._updateContactpoint();
        if (g.previousContactpoint == null || g.previousContactpoint === "")
          return;
        var a =
          g.previousContactpoint === g.serverPrefillContactpoint
            ? "server_prefill"
            : "browser_onload";
    ...
    var h,
      ...
      m = {
        addToQueue: function (a, b, d, e, f, g, j, k) {
          if ((h || (h = c("CookieConsent"))).hasFirstPartyConsent()) {
            f
              ...
              : c("Cookie").setWithoutChecks(a, b, d, e, j, k);
            return;
          }
          if (i.has(a)) return;
          i.set(a, {
        ...
        flushAllCookiesWithoutRecordingConsentDONOTCALLBEFORECONSENT:
          function () {
            ...
            for (
              ...
              (
                h || (h = c("CookieConsent"))
              ).hasIndividualThirdPartyIntegrationConsent(a[0]) &&
                a[1].fireCallbacks();
            }
          },
        flushAllCookiesINTERNALONLY: function (a, d, e, f, g, h, i) {
          ...
          if (!j) {
            ...
            g = new (c("URLSearchParams"))(location.search).get(
              "ig_3p_controls"
            );
            if (g === "on") {
            ...
            b("cr:3376") != null
              ? c("promiseDone")(
                  b("cr:3376")(f.toString(), { data: d, method: "POST" }),
                  function () {
                    return l();
                  },
                  function (a) {
        ...
        registerCallbackOnFirstPartyCookieFlush: function (a) {
          (h || (h = c("CookieConsent"))).hasFirstPartyConsent()
            ? a()
            : (k.has(1) || k.set(1, new (c("SubscriptionList"))()),
              c("nullthrows")(k.get(1)).add(a));
        },
        registerCallbackOnCookieFlushWithIntegrations: function (a, b) {
          var d = (h || (h = c("CookieConsent"))).hasThirdPartyConsent([a]);
          d.get(a) === !0
            ? b()
            : (l.has(a) || l.set(a, new (c("SubscriptionList"))()),
              c("nullthrows")(l.get(a)).add(b));
        },
      };
    a = m;
    g["default"] = a;
    ...
    function a(a, d, e, f) {
      ...
      return i.subtle
        ...
        .then(function (a) {
          ...
          if (b.length !== o + c("tweetnacl-sealedbox-js").overheadLength)
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a) {
      ...
      b("cr:4425") && b("cr:4425").showErrorDialog(a);
    }
    var i = !1;
    function d() {
      if (i) return;
  ...
  function (a, b, c, d, e, f, g, h) {
    ...
    function k() {
      document.documentElement &&
        d("VirtualCursorStatus").add(document.documentElement, s);
    }
    function l() {
      q = i.map(function (a) {
    ...
    function t(a) {
      j.indexOf(c("Event").getKeyCode(a)) > -1 &&
        c("KeyEventController").filterEventTargets(a, "keydown") &&
        u();
    }
    function u() {
      w.remove(),
        l(),
        (o = !0),
        document.body && d("CSS").removeClass(document.body, "_19_u");
    }
    function v() {
      r(),
        m(),
...
__d(
  ...
  function (a, b, c, d, e, f) {
    ...
    a = (function () {
      ...
      c.log = function (a) {
        b("GeneratedLoggerUtils").log(
          "logger:FourOhFourJSLoggerConfig",
          this.$1,
          b("Banzai").BASIC,
          a
        );
    ...
    var g = { fbid: !0, original_uri: !0, script_path: !0 };
    f["default"] = a;
  },
  66
);
__d(
  "FourOhFourJSLogger",
  ["FourOhFourJSTypedLogger", "ScriptPath"],
  function (a, b, c, d, e, f) {
    a = {
      log: function () {
      ...
      e.enableFullScreen = function (a) {
        ...
        if (a.webkitRequestFullScreen)
          d("UserAgent_DEPRECATED").chrome()
            ? a.webkitRequestFullScreen == null
              ? void 0
          ...
          k(), a.msRequestFullscreen == null ? void 0 : a.msRequestFullscreen();
...
__d(
  "LoggedOutSwitchingLocaleTypedLogger",
  ...
  function (a, b, c, d, e, f) {
    ...
    a = (function () {
      ...
      c.log = function (a) {
        b("GeneratedLoggerUtils").log(
          "logger:LoggedOutSwitchingLocaleLoggerConfig",
          this.$1,
          b("Banzai").BASIC,
          a
        );
    ...
    c = { index: !0, new_locale: !0, old_locale: !0, referrer: !0 };
    f["default"] = a;
  },
  66
);
    ...
    a = (function () {
      function a(a, b, c) {
        ...
        for (var f = 0; f < b.length; ++f) {
          ...
          this.$1[e].required
            ? i && g(0, 5050, e)
            : i || this.$1[e].defaultValue != null || g(0, 5057, e);
...
__d(
  "XIntlAccountSetLocaleAsyncController",
  ["XController"],
  function (a, b, c, d, e, f) {
    e.exports = b("XController").create("/intl/ajax/save_locale/", {
      ...
      index: { type: "Int" },
      ref: { type: "String" },
      ls_ref: { type: "Enum", defaultValue: "unknown", enumType: 1 },
      should_redirect: { type: "Bool", defaultValue: !0 },
      is_caa: { type: "Bool", defaultValue: !1 },
    });
  },
  null
);
__d(
  "XIntlSaveXModeAsyncController",
  ["XController"],
  function (a, b, c, d, e, f) {
...
__d(
  ...
  function (a, b, c, d, e, f, g, h) {
    ...
    function k(a, b, e, f) {
      ...
      new (c("AsyncRequest"))()
        .setURI(e)
        .setData({ loc: f, ref: b, should_redirect: !1 })
    ...
    function m(a, b, d, e, f) {
      e === void 0 && (e = "unknown"),
        f === void 0 && (f = null),
        c("Cookie").setWithoutCheckingUserConsent_DANGEROUS("locale", a),
        l(a),
    ...
    function n(a, b, c, d, e, f, g) {
      d
        ? (a.onclick = function (a) {
            a.preventDefault(), a.stopPropagation(), k(null, e, b);
          })
        : (a.onclick = function (a) {
            a.preventDefault(), a.stopPropagation(), m(b, c, f, e, g);
          });
    }
    g.setXmode = a;
    ...
    g.setCookieLocale = m;
    g.initOnClickHandler = n;
  },
  98
);
__d(
  "KeyboardActivityTypedLogger",
  ["Banzai", "GeneratedLoggerUtils"],
  function (a, b, c, d, e, f) {
    "use strict";
    a = (function () {
      ...
      c.log = function (a) {
        b("GeneratedLoggerUtils").log(
          "logger:KeyboardActivityLoggerConfig",
          this.$1,
          b("Banzai").BASIC,
          a
        );
...
__d(
  ...
  ["Event", "KeyboardActivityTypedLogger", "Keys", "isElementInteractive"],
  function (a, b, c, d, e, f, g) {
    b = ["tab", "right", "left", "up", "down", "enter"];
    var h = b.reduce(function (a, b) {
        a[b] = { count: 0, startTS: 0 };
        return a;
      }, {}),
      i = 20;
    function a() {
...
__d(
  "LoginServicePasswordEncryptDecryptEventTypedLogger",
  ["Banzai", "GeneratedLoggerUtils"],
  function (a, b, c, d, e, f) {
    "use strict";
    a = (function () {
      ...
      c.log = function (a) {
        b("GeneratedLoggerUtils").log(
          "logger:LoginServicePasswordEncryptDecryptEventLoggerConfig",
          this.$1,
          b("Banzai").BASIC,
          a
        );
    ...
    var h,
      i = {
        init: function (a, b, d, e, f, g) {
          g === void 0 && (g = !1),
            i._initShared(a, b, d, e, f, g),
            (i.isCredsManagerEnabled = !1),
            !f || !f.pubKey
              ? c("Event").listen(a, "submit", i._sendLoginShared.bind(i))
              : c("Event").listen(a, "submit", function (b) {
                  b.preventDefault(),
                    i._sendLoginShared.bind(i)(),
                    i._encryptBeforeSending(function () {
                      a.submit();
                    });
                });
        },
        initAsync: function (a, b, d, e, f, g) {
          g === void 0 && (g = !1),
            i._initShared(a, b, d, e, f, g),
            (i.isCredsManagerEnabled = !0),
            (i.emailInput = c("DOM").scry(a, 'input[id="email"]')[0]),
            (i.passwordInput = c("DOM").scry(a, 'input[id="pass"]')[0]),
            (i.errorBox = c("DOM").scry(a, 'input[id="error_box"]')[0]),
        ...
        _initShared: function (a, b, d, e, f, g) {
          ...
          i.loginFormParams = f;
          i.sharedPrefs = g;
          i.loginForm.shared_prefs_data &&
            void c(
              "BDClientSignalCollectionTrigger"
            ).startLoginTimeSignalCollection(c("BDSignalCollectionData"));
          ...
          if ((window.crypto || window.msCrypto) && d) {
            ...
            c("promiseDone")(
              ...
              function (c) {
                ...
                new f()
                  .setError("BrowserEncryptionFailureInLoginFormControllerWWW")
                  .setGrowthFlow("Bluebar/main login WWW")
                  .setErrorMessage(c.message)
                  .setPasswordTag(d)
                  .setPasswordEncryptionVersion(e)
                  .setPasswordTimestamp(g)
                  .logVital();
                a();
              }
            );
        ...
        _sendLoginShared: function () {
          i.abTesting &&
            i.loginForm.ab_test_data &&
            (i.loginForm.ab_test_data.value = i.formABTest.getData());
          i.sharedPrefs &&
            i.loginForm.shared_prefs_data &&
            (i.loginForm.shared_prefs_data.value = c("Base64").encode(
              c("BDClientSignalCollectionTrigger").getSignalsAsJSONString()
            ));
          var a = c("guid")();
        ...
        _sendLoginRequest: function () {
          i._sendLoginShared();
          if (i.login_form_params && i.login_form_params.pubKey)
            i._encryptBeforeSending(function () {
              var a = d("Form").serialize(i.loginForm);
              new (c("AsyncRequest"))()
                .setURI(i.loginForm)
                .setData(a)
                .setHandler(i._onLoginResponse.bind(i))
                .send();
            });
          else {
            var a = d("Form").serialize(i.loginForm);
            new (c("AsyncRequest"))()
              .setURI(i.loginForm.action)
              .setData(a)
              .setHandler(i._onLoginResponse.bind(i))
              .send();
          }
        ...
        _initSmartLockAccountChooser: function (a) {
          a === void 0 && (a = "silent"),
            window.PasswordCredential &&
              ...
              navigator.credentials
                .get({ password: !0, mediation: a })
                .then(function (b) {
                  b !== null &&
                  b.type === "password" &&
                  b.password !== null &&
                  b.id !== null
                    ? (i.emailInput.setAttribute("value", b.id),
                      i.passwordInput.setAttribute("value", b.password),
                      a === "required" && i._sendLoginRequest())
                    : (i.passwordInput.setAttribute("value", ""),
                      a === "silent" &&
                        i._initSmartLockAccountChooser("required"));
                })
                ["catch"](function (a) {
                  c("FBLogger")("login")
                    .catching(a)
                    .warn("smart lock promise fail");
                });
        },
      };
    a = i;
  ...
  function (a, b, c, d, e, f, g, h) {
    ...
    function a(a, b) {
      ...
      Event.listen(e, "keyup", function () {
        ...
        c.length !== 0
          ? (d("CSS").show(a), d("CSS").addClass(b, "_9ls8"))
          : d("CSS").hide(a);
      });
      var f = !0;
      Event.listen(a, "click", function () {
        (f = !f),
          d("CSS").removeClass(b, f ? "_9ls9" : "_9ls8"),
          d("CSS").addClass(b, f ? "_9ls8" : "_9ls9"),
          c("DOM").setAttributes(e, { type: f ? "password" : "text" });
      });
      var g = c("ge")("passContainer");
      g !== null &&
        (Event.listen(e, "focus", function () {
    ...
    function b(a, b, e, f) {
      ...
      Event.listen(a, "click", function () {
        (g = !g),
          d("CSS").removeClass(b, g ? "_9ls9" : "_9ls8"),
          d("CSS").addClass(b, g ? "_9ls8" : "_9ls9"),
          c("DOM").setAttributes(e, { type: g ? "password" : "text" });
      });
      f != null &&
        (Event.listen(e, "focus", function () {
...
__d(
  "LoginInitialLoadLogger",
  ["QuickLogActionType", "QuickPerformanceLogger", "Run", "qpl"],
  function (a, b, c, d, e, f, g) {
    "use strict";
    var h,
      i = 1,
    ...
    a = {
      onLoad: function (a) {
        (h || (h = c("QuickPerformanceLogger"))).markerStartFromNavStart(
          c("qpl")._(250350617, "2444"),
          i
        );
        var b = h.currentTimestamp();
        h.markerStart(c("qpl")._(250350617, "2444"), j, b);
        d("Run").onLoad(function () {
          (h || (h = c("QuickPerformanceLogger"))).markerAnnotate(
            c("qpl")._(250350617, "2444"),
            { string: { tracePolicy: "blue." + a, type: "onLoad" } },
            { instanceKey: i }
          );
          h.markerEnd(c("qpl")._(250350617, "2444"), 2, i);
          var d = new PerformanceObserver(function (d) {
            d = d.getEntries();
            ...
            (h || (h = c("QuickPerformanceLogger"))).markerAnnotate(
              c("qpl")._(250350617, "2444"),
              { string: { tracePolicy: "blue." + a, type: "lcp" } },
              { instanceKey: j }
            );
            h.markerEnd(
              c("qpl")._(250350617, "2444"),
              c("QuickLogActionType").SUCCESS,
              j,
              b + d.startTime
            );
          });
          d.observe({ type: "largest-contentful-paint", buffered: !0 });
        });
      },
      endMarker: function () {},
    };
...
__d(
  "jsExtraRouteBuilder",
  ["jsRouteBuilder", "unrecoverableViolation"],
  function (a, b, c, d, e, f, g) {
    "use strict";
    function a(a, b, d, e) {
      var f = c("jsRouteBuilder")(a, b, e),
        g = d.reduce(function (a, d) {
          a === void 0 && (a = {});
          typeof d === "string" &&
            (a[d] = c("jsRouteBuilder")(d, b, e, null, !0).buildURL);
          return a;
        }, {});
      return {
        buildExtraURL: function (a, b) {
          if (typeof a !== "string" || g[a] == null)
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a) {
      var b,
        e = (b = d("DateConsts")).MIN_PER_HOUR * b.HOUR_PER_DAY,
        f = new Date(),
      ...
      f != 0 &&
        c("FBLogger")("TimezoneAutoset").info(
          "Adjusting timezone offset for clock skew. Browser offset: %s. Raw skew %s. Rounded skew %s",
          g,
          a,
          f
        );
      b = Math.round(g + f) % e;
      b > 12 * d("DateConsts").MIN_PER_HOUR
        ? (b -= e)
        : b < -14 * d("DateConsts").MIN_PER_HOUR && (b += e);
      return b;
    }
    g["default"] = a;
  },
...
__d(
  ...
  function (a, b, c, d, e, f) {
    ...
    function h(a) {
      ...
      var f = b("getBrowserTimezone")();
      if (a || c != e || (f != null && f != d)) {
        e = b("XUpdateTimezoneControllerRouteBuilder").buildExtraURL(
          "/ajax/timezone/update.php",
          {}
        );
        new (b("AsyncRequest"))()
          .setURI(e)
          .setData({ tz: f, gmt_off: c, is_forced: a })
          .setErrorHandler(b("emptyFunction"))
          .setTransportErrorHandler(b("emptyFunction"))
