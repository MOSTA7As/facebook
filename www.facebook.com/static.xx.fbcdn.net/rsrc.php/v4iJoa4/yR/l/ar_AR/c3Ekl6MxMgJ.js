...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    a = c("jsRouteBuilder")(
      ...
      Object.freeze({ tab: "information", highlight_tax_id: !1 }),
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    "use strict";
    function a(a, b, d) {
      b = c("XAdsPEControllerRouteBuilder").buildUri(
    ...
    function b(a, b, d) {
      b = c("XAdsCMControllerRouteBuilder").buildUri(
        babelHelpers["extends"]({}, d, {
          nav_entry_point: (d = b) != null ? d : void 0,
          nav_source: a,
        })
    ...
    function d(a, b, d) {
      return c("XAdsCMAccountSettingsPageControllerRouteBuilder").buildUri(
        babelHelpers["extends"]({}, d, {
          nav_entry_point: (d = b) != null ? d : void 0,
          nav_source: a,
        })
    ...
    function h(a) {
      return a.includes("adsmanager") &&
        !c("AdsManagerReadRegions").excluded_endpoints.some(function (b) {
          return a.includes(b);
        }) &&
        c("gkx")("1221")
        ? !0
    ...
    var F = "for (;;);",
      ...
      H = (function () {
        ...
        e._invokeErrorHandler = function (a) {
          ...
          if (e === r)
            (g = i._(
              /*BTDS*/ "\u0644\u0627 \u0627\u062a\u0635\u0627\u0644 \u0628\u0627\u0644\u0634\u0628\u0643\u0629"
            )),
              (f = i._(
                /*BTDS*/ "\u064a\u0628\u062f\u0648 \u0623\u0646 \u0627\u0644\u0645\u062a\u0635\u0641\u062d \u0644\u062f\u064a\u0643 \u063a\u064a\u0631 \u0645\u062a\u0635\u0644. \u064a\u0631\u062c\u0649 \u0627\u0644\u062a\u062d\u0642\u0642 \u0645\u0646 \u0627\u0644\u0627\u062a\u0635\u0627\u0644 \u0628\u0627\u0644\u0625\u0646\u062a\u0631\u0646\u062a \u0648\u0625\u0639\u0627\u062f\u0629 \u0627\u0644\u0645\u062d\u0627\u0648\u0644\u0629."
              ));
          else if (e >= 300 && e <= 399) {
            g = i._(
              /*BTDS*/ "\u0625\u0639\u0627\u062f\u0629 \u0627\u0644\u062a\u0648\u062c\u064a\u0647"
            ...
            f = i._(
              /*BTDS*/ "\u062a\u0645\u062a \u0625\u0639\u0627\u062f\u0629 \u062a\u0648\u062c\u064a\u0647 \u0648\u0635\u0648\u0644\u0643 \u0625\u0644\u0649 \u0641\u064a\u0633 \u0628\u0648\u0643 \u0623\u0648 \u062d\u0638\u0631\u0647 \u0645\u0646 \u0642\u0628\u0644 \u0637\u0631\u0641 \u062b\u0627\u0644\u062b \u0641\u064a \u0647\u0630\u0627 \u0627\u0644\u0648\u0642\u062a\u060c \u064a\u0631\u062c\u0649 \u0627\u0644\u0627\u062a\u0635\u0627\u0644 \u0628\u0645\u0648\u0641\u0631 \u062e\u062f\u0645\u0629 \u0625\u0646\u062a\u0631\u0646\u062a \u0623\u0648 \u0625\u0639\u0627\u062f\u0629 \u0627\u0644\u062a\u062d\u0645\u064a\u0644."
            );
            ...
            (g = i._(/*BTDS*/ "\u0639\u0630\u0631\u0627\u064b")),
              (f = i._(
                /*BTDS*/ "\u062d\u062f\u062b \u062e\u0637\u0623\u060c \u0648\u0646\u0639\u0645\u0644 \u0639\u0644\u0649 \u0625\u0635\u0644\u0627\u062d\u0647 \u0641\u064a \u0623\u0642\u0631\u0628 \u0648\u0642\u062a \u0645\u0645\u0643\u0646. \u064a\u0645\u0643\u0646\u0643 \u0625\u0639\u0627\u062f\u0629 \u0627\u0644\u0645\u062d\u0627\u0648\u0644\u0629 \u0628\u0639\u062f \u0642\u0644\u064a\u0644."
              ));
          ...
          Object.assign(j, {
            ...
            errorDescription: f,
            silentError: a,
            errorMid: d.getResponseHeader("Error-Mid"),
          });
          c("setTimeout")(function () {
        ...
        e.send = function (b) {
          ...
          this.method == "GET" || this.rawData
            ? ((f = this.uri.addQueryData(this.data).toString()),
              (g = this.rawData || ""))
            : (this._allowCrossOrigin && this.uri.addQueryData({ __a: 1 }),
              (f = this.uri.toString()),
              (g = (k || (k = d("PHPQuerySerializer"))).serialize(this.data)));
          ...
          d("AdsManagerConstURIUtils").shouldRedirectToAMReadRegions(
            this.uri.toString()
          ) &&
            this.getReadOnly() &&
          ...
          this._isBackgroundRequest &&
            i.setRequestHeader("X-FB-BACKGROUND-STATE", "1");
          ...
          if (i)
            for (h in this.headers)
              Object.prototype.hasOwnProperty.call(this.headers, h) &&
                i.setRequestHeader(h, this.headers[h]);
...
__d(
  ...
  function (a, b, c, d, e, f) {
    ...
    function i(a) {
      ...
      var c = { fbpage_fan_confirm: !0, photos_snowlift: !0 },
        d;
